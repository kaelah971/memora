...
import { getFollowUpActionVisibility } from "@/lib/data/follow-up-builder";
import type {
  FollowUpOpportunity,
  FollowUpStatus,
...
function FollowUpCard({ opportunity }: { opportunity: FollowUpOpportunity }) {
  ...
  return (
    <article className="follow-up-card" aria-labelledby={`${opportunity.id}-title`}>
      ...
      <footer className="follow-up-card__actions">
        ...
        <div className="follow-up-card__action-buttons">
          <button className="secondary-button" type="button" disabled={isMindPending || isPostPending} onClick={askMind}>
